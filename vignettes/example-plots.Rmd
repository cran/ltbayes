...
%\VignetteIndexEntry{Plots from Johnson & Kuhn (2014)}
-->
...
Posterior distribution of $\zeta$ for the hyperbolic cosine model given $\tilde{y} = 1$ (a), $y' = (1,0,0,0,0)$ (b), $y' = (1,1,1,0,0)$ (c), and $y' = (0,1,1,1,0)$ (d).
...
Johnson, T. R. & Kuhn, K. M. (2014). *Simulation-Based Bayesian Inference for Latent Traits of Item Response Models: Introduction to the* **ltbayes** *Package for R*. Unpublished manuscript. 
